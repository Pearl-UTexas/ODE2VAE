...
def rotate_data(images, labels, K=16):
    ...
    if not tf.gfile.Exists("data/rotated"):
        tf.gfile.MakeDirs("data/rotated")
...
def prepare_MNIST_data():
    ...
    if len(sys.argv) == 1:
        ...
        raise InputError('number of input parameters is wrong! exiting...')
...
io.savemat('rot-mnist-3s.mat',{'X':rot_train_data,'Y':rot_train_labels})
