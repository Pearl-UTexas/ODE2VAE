...
class ODE2VAE_Args:
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            "--data_root", type=str, default="data", help="root of the data folder"
        )
        self.parser.add_argument(
            "--ckpt_dir", type=str, default="checkpoints", help="checkpoints folder"
        )
        self.parser.add_argument(
            "--task", type=str, default="mocap_many", help="experiment to execute"
        )
        self.parser.add_argument(
            "--f_opt",
            type=int,
        ...
        self.parser.add_argument(
            "--q", type=int, default=10, help="latent dimensionality"
        )
        self.parser.add_argument(
            "--gamma",
            type=float,
        ...
        self.parser.add_argument(
            "--Ne", type=int, default=2, help="number of hidden layers in encoder"
        )
        self.parser.add_argument(
            "--Nd", type=int, default=2, help="number of hidden layers in  decoder"
        )
        self.parser.add_argument(
            "--NF_enc",
            type=int,
        ...
        self.parser.add_argument(
            "--KW_enc", type=int, default=5, help="encoder kernel width"
        )
        self.parser.add_argument(
            "--KW_dec", type=int, default=5, help="decoder kernel width"
        )
        self.parser.add_argument(
            "--eta", type=float, default=0.001, help="learning rate"
        )
        self.parser.add_argument(
            "--batch_size",
            type=int,
        ...
        self.parser.add_argument(
            "--num_epoch", type=int, default=1000, help="number of training epochs"
        )
        self.parser.add_argument(
            "--subject_id",
            type=int,
